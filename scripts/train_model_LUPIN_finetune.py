...
def main(configpath, checkpoint=None):
    ...
    modelconf_foundation = load_config("/data/lagrangian-nowcasting/configs/LUPIN_differenced/model.yaml")
    ...
    model_base = LUPIN(modelconf_foundation).load_from_checkpoint("/data/lagrangian-nowcasting/checkpoints/xxx", config=modelconf_foundation)
    model = LUPIN(modelconf)
