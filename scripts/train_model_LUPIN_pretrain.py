...
def main(configpath, checkpoint=None):
    ...
    modelconf_mf = load_config("/data/lagrangian-nowcasting/configs/MFUNET_logcosh/model.yaml")
    ...
    model_mf = MFUNET(modelconf_mf).load_from_checkpoint("/data/lagrangian-nowcasting/checkpoints/xxx", config=modelconf_mf)
