"""Contains modules of class BasePredictionWriters for use when creating predictions using PyTorch Lightning library."""
import torch
...
class LagrangianHDF5Writer(BasePredictionWriter):
    """
    Class BasePredictionWriters for use when creating predictions from Lagrangian coordinates to HDF5 file using PyTorch Lightning library.
    """
    def __init__(
        self,
        output_dir: str,
            ...
            if not self.write_leadtimes_separately:
                ...
                with h5py.File(fn, "a") as f:
                    ...
                    base_what = {
                        ...
                        "source": np.string_("NOD:sk;ORG:sk"),
                    }
